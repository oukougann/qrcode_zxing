package com.example.wanghong.qrcode_zxing.utils;
...
import com.example.wanghong.qrcode_zxing.CaptureFragment;
import com.example.wanghong.qrcode_zxing.camera.BitmapLuminanceSource;
import com.example.wanghong.qrcode_zxing.camera.CameraManager;
import com.example.wanghong.qrcode_zxing.decoding.DecodeFormatManager;
...
public class CodeUtils {
     ...
     *
     * @param uri             Uri
     * @param analyzeCallback 回调接口
     */
    public static void analyzeBitmap(@NonNull Context context, @NonNull Uri uri, @NonNull AnalyzeCallback analyzeCallback) {
        String imageAbsolutePath = getImageAbsolutePath(context, uri);
        analyzeBitmap(imageAbsolutePath, analyzeCallback);
    }
     ...
     *
     * @param captureFragment Fragment
